...
namespace DaeSMOKE
{
	...
	const unsigned int MethodGear<DAESystemKernel>::MIN_ORDER = 1;
	template <typename DAESystemKernel>
	const unsigned int MethodGear<DAESystemKernel>::MAX_ORDER = 5;
	template <typename DAESystemKernel>
	const unsigned int MethodGear<DAESystemKernel>::DEFAULT_MAX_CONVERGENCE_ITER = 4;
	template <typename DAESystemKernel>
	const unsigned int MethodGear<DAESystemKernel>::MAX_ITERATIONS_FACTORIZATION = 20;
	template <typename DAESystemKernel>
	const unsigned int MethodGear<DAESystemKernel>::MAX_ITERATIONS_JACOBIAN = 50;
	template <typename DAESystemKernel>
	const double MethodGear<DAESystemKernel>::DELTA_ALFA1 = .05;
	template <typename DAESystemKernel>
	const double MethodGear<DAESystemKernel>::ALFA2 = .8;
	template <typename DAESystemKernel>
	const double MethodGear<DAESystemKernel>::DELTA_ALFA3 = .25;
	template <typename DAESystemKernel>
	const unsigned int MethodGear<DAESystemKernel>::MAX_CONVERGENCE_FAILURE = 50;
	...
	unsigned int MethodGear<DAESystemKernel>::FindCorrection(const double t, const Eigen::VectorXd& errorWeights, const Eigen::VectorXd& errorWeightsSystem)
	{
		...
		if (factorizationStatus_ == MATRIX_HAS_TO_BE_FACTORIZED)
		{
			...
			this->BuildAndFactorizeMatrixG(hr0, r_[0](p_ - 1));
