...
#ifndef DaeKernelBand_H
#define DaeKernelBand_H
...
namespace DaeSMOKE
{
	...
	class KernelBand : public DaeSystemObject
	{
	public:
		...
		*@brief Summary
		*/
		void DaeSolverKernelSummary(std::ostream& out);
	...
	protected:
		...
		*@param rr0 integration order (used by algebraic equations)
		*/
		void BuildAndFactorizeMatrixG(const double hr0, const double rr0);
	...
	protected:
		...
		std::vector<OpenSMOKE::EquationType>	equation_type_;		//!< algebraic vs differential equations
