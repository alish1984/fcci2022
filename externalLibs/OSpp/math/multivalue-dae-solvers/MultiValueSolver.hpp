	...
	unsigned int MultiValueSolver<Method>::CheckIllegalConstraints(const Eigen::VectorXd& y)
	{
		...
		if (this->min_constraints_ == true)
		{
			if (abs_tolerances_scalar_ == true)
			{
				...
				{
					std::cout << std::scientific << "Illegal minimum: " << i << " " << y(i) << " " << this->min_values_(i) << " " << abs_tolerance_ << std::endl;
			...
			else if (abs_tolerances_scalar_ == false)
			{
				...
				{
					std::cout << std::scientific << "Illegal minimum: " << i << " " << y(i) << " " << this->min_values_(i) << " " << abs_tolerances_(i) << std::endl;
					number_of_illegal_constraints_++;
				}
			}
		}
		...
		if (this->max_constraints_ == true)
		{
			if (abs_tolerances_scalar_ == true)
			{
				for (unsigned int i = 0; i < this->ne_; i++)
					...
					{
						std::cout << std::scientific << "Illegal maximum: " << i << " " << y(i) << " " << this->max_values_(i) << " " << abs_tolerance_ << std::endl;
						number_of_illegal_constraints_++;
					}
			}
			else if (abs_tolerances_scalar_ == false)
			{
				for (unsigned int i = 0; i < this->ne_; i++)
					...
					{
						std::cout << std::scientific << "Illegal maximum: " << i << " " << y(i) << " " << this->max_values_(i) << " " << abs_tolerances_(i) << std::endl;
						number_of_illegal_constraints_++;
					}
			}
		}
