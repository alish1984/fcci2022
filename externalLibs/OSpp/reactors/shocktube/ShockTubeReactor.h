...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*/		
		void EnableSensitivityAnalysis(OpenSMOKE::SensitivityMap<double>& sensitivityMap, OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, ShockTubeReactor_Options& batch_options, OpenSMOKE::SensitivityAnalysis_Options& sensitivity_options);
		...
		*@param thermodynamicsMap map of thermodynamic data
		*/			
		void FinalStatus(const double tf, OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, const ShockTubeReactor_Options& shocktube_options);
		...
		*@param thermodynamicsMap map of thermodynamic data
		*/		
		void FinalSummary(const boost::filesystem::path summary_file, const double tf, OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap);
	...
	protected:
		...
		*/
		void PrepareASCIIFile(const boost::filesystem::path output_file_ascii, OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, ShockTubeReactor_Options& shocktube_options);
		...
		*@param shocktube_options options for solving the shock tube reactor
		*/
		void PrepareSensitivityXMLFiles(OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, ShockTubeReactor_Options& shocktube_options, OpenSMOKE::SensitivityAnalysis_Options& sensitivity_options);
		...
		*@param shocktube_options options for solving the shock tube reactor
		*/
		void OpenAllFiles(OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, OpenSMOKE::ShockTubeReactor_Options& shocktube_options);
		
		/**
		*@brief Closes all the files (ASCII and XML)
		*@param shocktube_options options for solving the shock tube reactor
		*/		
		void CloseAllFiles(OpenSMOKE::ShockTubeReactor_Options& shocktube_options);
