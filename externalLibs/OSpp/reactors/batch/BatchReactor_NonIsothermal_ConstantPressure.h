...
namespace OpenSMOKE
{
	...
	*/
	...
	class BatchReactor_NonIsothermal_ConstantPressure : public BatchReactor
	{
	...
	public:
		...
		*/
		BatchReactor_NonIsothermal_ConstantPressure(	OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, 
