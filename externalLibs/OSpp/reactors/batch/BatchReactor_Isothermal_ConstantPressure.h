...
namespace OpenSMOKE
{
	...
	*/
	...
	class BatchReactor_Isothermal_ConstantPressure : public BatchReactor
	{
	...
	public:
		...
		*/
		BatchReactor_Isothermal_ConstantPressure(	OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, 
