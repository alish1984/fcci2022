...
namespace OpenSMOKE
{
	...
	*/
	...
	class BatchReactor_NonIsothermal_ConstantVolume : public BatchReactor
	{
	...
	public:
		...
		*@param global_thermal_exchange_coefficient global thermal exchange coefficient [W/m2/K]
     		...
     		*/
		BatchReactor_NonIsothermal_ConstantVolume(	OpenSMOKE::ThermodynamicsMap_CHEMKIN<double>& thermodynamicsMap, 
