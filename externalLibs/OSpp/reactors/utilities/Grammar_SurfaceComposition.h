...
namespace OpenSMOKE
{
	...
	void GetSurfaceCompositionFromDictionary(	OpenSMOKE::OpenSMOKE_Dictionary& dictionary, ThermodynamicsMap& thermodynamicsMap, OpenSMOKE::OpenSMOKEVectorDouble& Z)
	{
