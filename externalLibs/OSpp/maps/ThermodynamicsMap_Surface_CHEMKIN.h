...
namespace OpenSMOKE
{
	...
	*/
	...
	class ThermodynamicsMap_Surface_CHEMKIN : public ThermodynamicsMap<map>
	{
	...
	public:
		...
		*/
		ThermodynamicsMap_Surface_CHEMKIN(const unsigned int nSpecies, const unsigned int nPoints = 1);
		...
		*@param nPoints number of points in the map (for a scalar map the number of points is 1)
		*/
		ThermodynamicsMap_Surface_CHEMKIN(rapidxml::xml_document<>& doc, const unsigned int nPoints = 1);
