...
#ifndef OpenSMOKE_Solve_Band_OpenSMOKEppOde_H
#define OpenSMOKE_Solve_Band_OpenSMOKEppOde_H
...
namespace OdeSMOKE
{
	...
	int Solve_Band_OpenSMOKEppOde(Object* object, const OdeSMOKE::OdeSolver_Parameters& parameters, const double t0, const double tEnd)
	{
		std::cout << "Band ODE solution (OpenSMOKE++)..." << std::endl;
		...
		typedef OdeSMOKE::KernelBand<System> bandOde;
		...
		ode_solver.SetBandSizes(object->UpperBand(), object->LowerBand());
...
#endif // OpenSMOKE_Solve_Band_OpenSMOKEppOde_H
